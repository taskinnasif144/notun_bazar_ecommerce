  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(
      ...
      items: <BottomNavigationBarItem>[
        ...
        BottomNavigationBarItem(
          icon: menuIndex == 1
              ? iconRender(url: AppIcons.heartIcon, color: color.getPrimary() )
              : iconRender(url: AppIcons.heartOutlinedIcon, color: color.getPrimary() ),
          label: 'Favourite',
        ),
        BottomNavigationBarItem(
          icon: menuIndex == 2
              ? iconRender(url: AppIcons.chatIcon, color: color.getPrimary() )
              : iconRender(url: AppIcons.chatOutlinedIcon, color: color.getPrimary() ),
          label: 'Messages',
        ),
        BottomNavigationBarItem(
          icon: menuIndex == 3
              ? iconRender(url: AppIcons.personICon, color: color.getPrimary() )
              : iconRender(url: AppIcons.personOutlinedIcon, color: color.getPrimary() ),
          label: 'Profile',
        ),
      ],
      onTap: onChanged,
